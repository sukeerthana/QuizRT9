...
export default class CreateGameApp extends React.Component {
  ...
  componentWillMount() {
    ...
    var me = this;
    me.context.socket.on('subscribedSuccess', function(data) {
      console.log('---> SUBSCRIBED SUCCESSFULLY TO LOBBY ' + data.data);
    ...
    $.ajax({
      url: restUrl + '/createLobby/' + username,
        ...
        success: function(data){
          ...
          me.context.socket.emit('createLobby', {data: dataToSend});
